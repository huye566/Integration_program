function [length_ico,length_ds]=integration_excel_ds(origin_dir)
 ...
 length_ico=length(excel_data(1:end,1));
 length_ds=file_num;
 ...
 for file_i=1:file_num
     ...
     [excel_data((file_i-1)*length_ico+1:file_i*length_ico,1:end,1),~,~]=xlsread(address_file,1);
     [excel_data((file_i-1)*length_ico+1:file_i*length_ico,1:end,2),~,~]=xlsread(address_file,2); 
     [excel_data((file_i-1)*length_ico+1:file_i*length_ico,1:end,3),~,~]=xlsread(address_file,3); 
 end
