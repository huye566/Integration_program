function  write_excel_for_diehard(filespec,data,data_range)
...
sheet.Range('A:U').Font.size = 10.5;
sheet.Range('A1:U1').ColumnWidth =11;
sheet.Range('A1:U1').Borders.Weight = 3;
