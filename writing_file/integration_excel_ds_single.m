function [data_ico,data_ds]=integration_excel_ds_single(origin_dir)
...
xlswrite(file_integration,figure_head,'sheet1','A1:M1');%最后两个是sym(average),acf(average);
 ...
 data_ico=excel_data(1:end,2);
 length_ico=length(data_ico);
 length_ds=file_num;
 ...
 data_ds=excel_data(1:length_ico,2,1);
